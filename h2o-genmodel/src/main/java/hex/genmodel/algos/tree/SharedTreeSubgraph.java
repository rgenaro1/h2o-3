...
class SharedTreeSubgraph {
  ...
  SharedTreeNode makeRootNode() {
    SharedTreeNode n = new SharedTreeNode(null, subgraphNumber, nodesArray.size(), 0, -1);
  ...
  SharedTreeNode makeLeftChildNode(SharedTreeNode parent) {
    SharedTreeNode child = new SharedTreeNode(parent, subgraphNumber, nodesArray.size(), parent.getDepth() + 1, -1);
